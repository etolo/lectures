...
For any <img src="https://latex.codecogs.com/svg.latex?\Large&space;k" title="a"/>-armed bandit problem such that arm reward distributions have support contained in <img src="https://latex.codecogs.com/svg.latex?\Large&space;[0,1]" title="a"/> and such that <img src="https://latex.codecogs.com/svg.latex?\Large&space;Q^*(a^*)-Q^*(a)\geq{d}" title="a"/> for each non-best arm <img src="https://latex.codecogs.com/svg.latex?\Large&space;a" title="a"/>, the <img src="https://latex.codecogs.com/svg.latex?\Large&space;\epsilon_t" title="a"/>-greedy algorithm with <img src="https://latex.codecogs.com/svg.latex?\Large&space;\epsilon_t" title="a"/> defined as above, has the regret bound:
